...
game_state_t* create_default_state() {
  ...
  game_state_t* default_state_ptr = malloc(sizeof(game_state_t));
  default_state_ptr->num_rows = 18;
  default_state_ptr->board = malloc(sizeof(char*) * 18);
  default_state_ptr->num_snakes = 1;
  default_state_ptr->snakes = malloc(sizeof(snake_t*));
  default_state_ptr->snakes->tail_row = 2;
  default_state_ptr->snakes->tail_col = 2;
  default_state_ptr->snakes->head_row = 2;
  default_state_ptr->snakes->head_col = 4;
  default_state_ptr->snakes->live = true;
 
  char** board = default_state_ptr->board;
  for (int i = 0; i < 18; i++) {   
...
static bool is_snake(char c) {
  // TODO: Implement this function.
  return (c=='^')||(c=='<')||(c=='>')||(c=='v')||is_tail(c)||is_head(c);
}
